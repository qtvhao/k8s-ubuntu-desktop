...
# Install Chrome
RUN wget -q https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb && dpkg -i google-chrome-stable_current_amd64.deb; apt update && apt-get -fy install && which google-chrome-stable && rm google-chrome-stable_current_amd64.deb && apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
